...
from app.services.order_service import get_all_orders, get_order_draft_by_room_id, update_order_draft_by_room_id, create_order_draft_by_room_id, get_all_order_draft_by_status
from app.core.database import get_db
from app.schemas.order import OrderOut, OrderDraftOut, OrderDraftUpdate, OrderDraftCreate, OrderDraftStatusOut
...
@api_router.get("/orderdraft/status", response_model=Optional[List[OrderDraftStatusOut]])
async def get_all_collecting_order_draft(db: AsyncSession = Depends(get_db)):
    return await get_all_order_draft_by_status(db, status=OrderDraftStatus.COLLECTING)
